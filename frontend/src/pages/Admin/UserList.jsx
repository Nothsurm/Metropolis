                                    ...
                                    {editableUserId === user._id ? (
                                        <div className="flex items-center">
                                            <input 
                                                ...
                                                onChange={(e) => setEditableUserName(e.target.value)} className="w-full p-2 border rounded-lg bg-zinc-600"
                                            />
                                            <button 
                                    ...
                                    {editableUserId === user._id ? (
                                        <div className="flex items-center">
                                            <input 
                                                ...
                                                onChange={(e) => setEditableUserEmail(e.target.value)} className="w-full p-2 border rounded-lg bg-zinc-600"
                                            />
                                            <button 
                                                onClick={() => updateHandler(user._id)} 
