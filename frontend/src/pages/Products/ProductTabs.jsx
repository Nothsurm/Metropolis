                        ...
                        <form onSubmit={submitHandler}>
                            <div className="my-2">
                                ...
                                <select 
                                    ...
                                    className="p-2 border rounded-lg xl:w-[40rem] bg-zinc-600"
                                >
                            ...
                            <div className="my-2">
                                ...
                                <textarea id='comment' rows='3' required value={comment} onChange={(e) => setComment(e.target.value)} className="p-2 border rounded-lg xl:w-[40rem] bg-zinc-600">
                ...
                <>
                    ...
                    <div>
                        {product.reviews.map((review) => (
                            <div key={review._id} className="bg-[#1A1A1A] p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[25rem] mb-5">
