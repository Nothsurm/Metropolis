    ...
    <>
        <div className="container mx-auto">
            <div className="flex md:flex-row sm:mt-16 xl:mt-0"  id='container'>
                <div className="bg-[#151515] p-3 mt-2 mb-2" id='filter-container'>
                            ...
                            <div key={c._id} className="mb-2">
                                <div className="flex items-center mr-4">
                                    <input 
                                        ...
                                        className="w-4 h-4 text-pink-600 bg-zinc-600 border-gray-300 rounded focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
                            ...
                            <>
                                <div className="flex items-center mr-4 mb-5">
                                    <input 
                                        ...
                                        className="w-4 h-4 text-pink-400 bg-zinc-600 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 "
                                    />
                                    <label 
                                        htmlFor='pink-radio' 
                    ...
                    <div className="p-5 w-[15rem]">
                        <input 
                            ...
                            className="w-full bg-zinc-600 px-3 py-2 placeholder-gray-400 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
                        />
                    </div>
                    <div className="p-5">
                ...
                <div className="p-3">
                    <h2 className="text-center text-bold text-3xl mb-2">
